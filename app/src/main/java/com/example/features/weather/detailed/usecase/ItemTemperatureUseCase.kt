                ...
                items.add(
                    ItemTemperature(
                        ...
                        if (today.temp.toInt() > yesterday.temp.toInt()) {
                            "Было на ${kotlin.math.abs(today.temp.toInt() - yesterday.temp.toInt())}° теплее"
                        } else if (today.temp.toInt() == yesterday.temp.toInt()) {
                            "Температура такая же"
                        } else {
                            "Было на ${kotlin.math.abs(today.temp.toInt() - yesterday.temp.toInt())}° прохладнее"
                        }
                ...
                items.add(
                    ItemTemperature(
                        ...
                        if (today.temp.toInt() > tomorrow.temp.toInt()) {
                            "Будет на ${kotlin.math.abs(today.temp.toInt() - tomorrow.temp.toInt())}° теплее"
                        } else if (today.temp.toInt() == tomorrow.temp.toInt()) {
                            "Ожидается такая же температура"
                        } else {
                            "Будет на ${kotlin.math.abs(today.temp.toInt() - tomorrow.temp.toInt())}° прохладнее"
                        }
                    )
                )
            }
